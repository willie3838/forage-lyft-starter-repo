...
import os, sys; sys.path.append(os.path.dirname(os.path.realpath("./main/carFactory.py")))
...
class TestCalliope(unittest.TestCase):
    def test_engine_should_be_serviced(self):
        ...
        print("last_service_date: ", last_service_date)
        current_mileage = 30001
        last_service_mileage = 0

        car = CarFactory.createCalliope(last_service_date, current_mileage, last_service_mileage)
